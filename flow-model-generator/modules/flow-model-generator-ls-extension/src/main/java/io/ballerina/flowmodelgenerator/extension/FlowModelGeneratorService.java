...
import io.ballerina.flowmodelgenerator.extension.response.FlowModelGeneratorServiceResponse;
import io.ballerina.flowmodelgenerator.extension.response.FlowModelSourceGeneratorServiceResponse;
    ...
    public CompletableFuture<FlowModelSourceGeneratorServiceResponse> getSourceCode(
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                response.setTextEdits(sourceGenerator.toSourceCode(request.getDiagramNode()));
            } catch (Throwable e) {
                throw new RuntimeException(e);
                //TODO: Handle errors generated by the flow model generator service.
            }
