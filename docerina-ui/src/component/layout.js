...
import "../../public/syntax-highlighter/prism-ballerina"
                                ...
                                <div className="ui breadcrumb">
                                    ...
                                    {props.pageType != "module" &&
                                        <span>
                                            <i className="right angle icon divider"></i>
                                            {hasChildPages ?
                                                (<span><Link to={"/" + props.module.id + "#" + props.pageType} className="section capitalize">{props.pageType}</Link><i className="right angle icon divider"></i><p className="section capitalize active">{props.name}</p></span>)
                                                :
