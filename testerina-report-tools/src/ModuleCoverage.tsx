...
class ModuleCoverageSummary extends Component<{ module: ModuleCoverage, modIndex: number, projectIndex?: number, updateState: Function}> {
    render () {
            ...
            <table className="table table-striped table-borderless">
                ...
                {data.sourceFiles.map((sourceFile, index) => {
                    return <tr id={sourceFile.name}>
                        <td><span className="link" onClick={() => this.props.updateState("coverage", this.props.modIndex, index, this.props.projectIndex)}>{sourceFile.name}</span></td>
